"""Train the LSTM baseline model for CO2 forecasting.

Usage:
    python scripts/train_lstm.py
    python scripts/train_lstm.py --horizon 1
    python scripts/train_lstm.py --horizon 24
"""
...
def train_single_horizon(config: dict) -> None:
    """Train LSTM for a single forecast horizon.
